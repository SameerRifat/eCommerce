                ...
                <div className="w-[90%] lg:w-[80%] mx-auto">
                    ...
                    <div className="w-full sm:w-[400px] mx-auto">
                        ...
                        <form className='form' onClick={submitHandler}>
                            ...
                            <input type="submit" value={`Pay - $${orderInfo && orderInfo.totalPrice}`} className='mt-4 w-full bg-gradient-to-tr from-pink-500 to-violet-500 hover:from-pink-600 hover:to-violet-600 rounded-md text-white py-3 font-semibold shadow-sm cursor-pointer disabled:opacity-[0.6]' ref={payBtn} />
                        </form>
                    </div>
                </div>
            </div>
